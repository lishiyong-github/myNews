...
@synthesize digg_button = _digg_button,bury_button = _bury_button,save_button = _save_button,comment_button  = _comment_button,share_button = _share_button,diggLabel = _diggLabel,buryLabel = _buryLabel,saveLabel = _saveLabel,commentLabel = _commentLabel,shareLabel = _shareLabel,imageView1 = _imageView1,contentLable = _contentLable;
...
//    self.textLabel.frame = CGRectMake(5, 5, 290, self.contentView.frame.size.height-self.imageView.frame.size.height-55);
//    self.imageView.frame = CGRectMake(5, self.textLabel.frame.origin.y+10, 290, 200);
    _diggLabel.frame = CGRectMake(5, self.contentView.frame.size.height-25, 60, 15);
    _digg_button.frame = CGRectMake(6, _diggLabel.frame.origin.y+1, 58, 13);
