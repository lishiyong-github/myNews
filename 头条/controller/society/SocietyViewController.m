...
@synthesize textArray = _textArray,societyDelegate = _societyDelegate;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.societyDelegate openDetailModelView:model.share_url];
