...
@synthesize text_label = _text_label,digg_button = _digg_button,bury_button = _bury_button,save_button = _save_button,comment_button  = _comment_button,share_button = _share_button,diggLabel = _diggLabel,buryLabel = _buryLabel,saveLabel = _saveLabel,commentLabel = _commentLabel,shareLabel = _shareLabel;
...
-(void)layoutSubviews
{
    ...
    _text_label.frame = CGRectMake(5, 5, 290, self.contentView.frame.size.height-30);
    _diggLabel.frame = CGRectMake(5, _text_label.frame.size.height+10, 60, 15);
    _digg_button.frame = CGRectMake(6, _text_label.frame.size.height+11, 58, 13);
